...
By using the til.my.id subdomain service ("Service"), you agree to comply with and be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.

## 2. Description of Service

til.my.id provides free subdomains for personal and project use, with limited email support, subject to these Terms.
...
You agree to indemnify and hold harmless til.my.id and its affiliates from any claims resulting from your use of the Service.
...
For questions about these Terms, please email contact@til.my.id
